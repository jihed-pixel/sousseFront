        ...
        <MDBContainer  >
              <MDBRow>
                <MDBCol >
                  ...
                  <FormInput placeholder="Température en °C"   type="number"  onChangeText={setTemperature} />
                <FormInput placeholder="FR  C/min"   type="number"  onChangeText={setFr} />
                <FormInput placeholder="FC bpm"   type="number"  onChangeText={setFc} />
                <FormInput placeholder="SaO2 %"   type="number"  onChangeText={setSao2} />
                ...
                <FormInput placeholder="Poids kg"   type="number"  maxLength={Number("3")} onChangeText={setPoids} />
